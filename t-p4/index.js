...
app.get('/topics', (req, res) => {
    fetchDocuments().then(topics => {
        res.json(topics);
    });
});

app.get('/cheap-topics', (req, res) => {
    fetchCheapDocuments().then(topics => {
        res.json(topics);
    });
});
...
app.post('/topic-add', (req, res) => {
    ...
    insertDocument(name, description, price).then(res.send({topicAdded: true}))
